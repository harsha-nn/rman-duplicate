...
var create_standby_using_bkp=document.getElementById("create_standby_using_bkp")
...
function create_ubkploc_duplicate() {
    ...
    if(omf_yes.checked && nofilename_no.checked){
        duplicate_cmd_ubkploc.push(`set control_files=<enter location>\n`)
...
function create_ucatnotar_duplicate(){
    ...
    duplicate_cmd_ucatnotar.push(`RMAN> \n`)
    ...
    if(omf_yes.checked && nofilename_no.checked){
        duplicate_cmd_ucatnotar.push(`set control_files=<enter location>\n`)
...
function targetless_with_catalog(){
    ...
    if(omf_yes.checked){
        document.getElementById("startup_nomount_ucatnotar").value=create_omf_pfile().join("")
    } else{
...
function create_using_target_bkp_duplicate(){
    ...
    if(omf_yes.checked && nofilename_no.checked){
        duplicate_cmd_usingtar.push(`set control_files=<enter location>\n`)
...
function create_standby_using_bkp_func(){
    ...
    if(disk.checked){
        ...
        document.getElementById("move_backup_stby").value=`You can skip this step. This is only applicable for disk backups`
    }
